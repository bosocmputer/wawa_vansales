...
PreOrderHistoryDetailModel _$PreOrderHistoryDetailModelFromJson(Map<String, dynamic> json) {
  return PreOrderHistoryDetailModel(
...
Map<String, dynamic> _$PreOrderHistoryDetailModelToJson(PreOrderHistoryDetailModel instance) => <String, dynamic>{
